...
class CRenderWorld : public sf::Drawable, public sf::Transformable
{
public:
	...
	void loadNewTiles(sf::Vector2u tileSize, const int* tiles, unsigned int width, unsigned int height)
	{
